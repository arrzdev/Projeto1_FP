...
def get_lastest_commit_hash():
    try:
        ...
        print(
            "N�o foi poss�vel verificar novas atualiza��es (o GitHub apenas permite 60 verifica��es por hora)"
        )
...
def check_for_updates():
    ...
    if saved_hash:
        if saved_hash == latest_hash:
            return
        print("Foi encontrada uma nova atualiza��o aos testes.")
    else:
        print("Esta � a primeira vez que est�s a correr o programa.")

    print(
        "Esta opera��o ir� substituir o teu ficheiro local com a nova vers�o, apagando quaisqueres altera��es que tenham sido feitas aos testes locais."
    )
    ...
    if response.lower() == 'y':
        ...
        print("Os testes n�o foram atualizados a pedido do utilizador")
